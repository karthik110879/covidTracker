...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "container-xxl", 2, "padding", ".5rem"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/feedback/feedback.component */
    "./src/app/components/feedback/feedback.component.ts");
    /* harmony import */
  ...
  function srcAppComponentsCountriesCountriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dashboard_card_dashboard_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    function CountriesComponent_option_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_div_25_tr_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_div_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CountriesComponent = /*#__PURE__*/function () {
      ...
      _createClass(CountriesComponent, [{
        ...
        value: function getStats() {
          ...
          this.service.getGlobalStatistics().subscribe({
            next: function next(data) {
              ...
              _this2.globalStatsData = response;
              _this2.selectedCountry = (_a = _this2.globalStatsData[0]) === null || _a === void 0 ? void 0 : _a.country;

              var index = _this2.globalStatsData.findIndex(function (country) {
                return country.country === _this2.selectedCountry;
              });

              if (index !== -1) {
                _this2.selectedCountryData = _this2.globalStatsData[index];
                _this2.totalConfirmed = _this2.selectedCountryData.cases.total !== null ? _this2.selectedCountryData.cases.total : 0;
                _this2.totalActive = _this2.selectedCountryData.cases.active !== null ? _this2.selectedCountryData.cases.active : 0;
                _this2.totalRecovered = _this2.selectedCountryData.cases.recovered !== null ? _this2.selectedCountryData.cases.recovered : 0;
                _this2.totalDeaths = _this2.selectedCountryData.deaths.total !== null ? _this2.selectedCountryData.deaths.total : 0;
              }
        ...
        value: function updateChart() {
          ...
          dataTable.push([this.selectedCountryData.day, this.selectedCountryData.cases]); // this.selectedCountryData.forEach(cs=>{
          // })
        ...
        key: "updateValues",
        value: function updateValues(selectedCountry) {
          console.log('SELECTED VALUE', selectedCountry);
          this.selectedCountry = selectedCountry;
          var index = this.globalStatsData.findIndex(function (country) {
    ...
    CountriesComponent.ɵfac = function CountriesComponent_Factory(t) {
      return new (t || CountriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_service_service__WEBPACK_IMPORTED_MODULE_1__["DataServiceService"]));
    };
    ...
    CountriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 26,
      vars: 9,
      consts: [[1, "ui", "inverted", "dimmer"], [1, "ui", "text", "loader"], [1, "bg-white", "text-center"], [1, "display-5"], [1, "lead"], [1, "mx-auto"], [1, "form-group", "col-lg-5", "mx-auto"], ["for", "c"], ["name", "", "id", "c", 1, "form-control", 3, "ngModel", "ngModelChange", "change"], ["input", ""], ["id", "new", 3, "value", 4, "ngFor", "ngForOf"], [1, "bg-light", "text-center", 2, "padding", ".6rem"], [1, "alert", "alert-warning"], [3, "totalConfirmed", "totalActive", "totalRecovered", "totalDeaths"], ["class", "row", 4, "ngIf"], ["id", "new", 3, "value"], [1, "row"], [1, "col"], [1, "table"], [4, "ngFor", "ngForOf"], ["value", "d", 2, "width", "100%", 3, "type", "options", "height", "data"]],
      template: function CountriesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CountriesComponent_Template_select_ngModelChange_13_listener($event) {
            return ctx.selectedCountry = $event;
          })("change", function CountriesComponent_Template_select_change_13_listener() {
  ...
  function srcAppComponentsDashboardCardDashboardCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardCardComponent = /*#__PURE__*/function () {
      function DashboardCardComponent(decimalPipe) {
    ...
    DashboardCardComponent.ɵfac = function DashboardCardComponent_Factory(t) {
      return new (t || DashboardCardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__["DecimalPipe"]));
    };
    ...
    DashboardCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 29,
      vars: 4,
      consts: [[1, "row"], [1, "card", "c1", "col", "p-3", "m-3"], [1, "ui", "statistic"], [1, "value"], [1, "label", "label-default"], [1, "card", "c2", "col", "p-3", "m-3"], [1, "card", "c3", "col", "p-3", "m-3"], [1, "card", "c4", "col", "p-3", "m-3"]],
  ...
  /***/
  function srcAppComponentsFeedbackFeedbackComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    FeedbackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 0,
      consts: [[1, "bg-white", "text-center"], [1, "display-5"], [1, "lead"], [1, "container", "d-flex", "justify-content-center"], [1, "row", 2, "gap", "6rem"], [1, "ui", "form"], [1, "field"], ["type", "text", "name", "first-name", "placeholder", "Your Name"], ["type", "text", "name", "last-name", "placeholder", "How would you rate this site out of 5?"], ["placeholder", "Please write some feedback here!!"], ["type", "submit", 1, "ui", "button"], [1, "right", "floated", "column"], ["src", "../../../assets/feedback.png", "alt", "", "height", "400px", "srcset", ""]],
  ...
  function srcAppComponentsFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 0,
      consts: [[1, "ui", "four", "column", "grid", "footer"], [1, "container"], [1, "column", "clma"], ["href", "https://github.com/CSSEGISandData/COVID-19", "target", "_blank", 1, "apicredits"], [1, "column", "clmb"]],
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular_google_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! angular-google-charts */
    "./node_modules/angular-google-charts/__ivy_ngcc__/fesm2015/angular-google-charts.js");
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getStats() {
          ...
          this.dataService.getGlobalStatistics().subscribe({
            next: function next(data) {
              console.log('data', data.response);
              var response = data.response;
              _this3.globalStatsData = response;

              _this3.globalStatsData.forEach(function (country) {
                if (country.country === 'All') {
                  _this3.totalConfirmed = country.cases.total !== null ? country.cases.total : 0;
                  _this3.totalActive = country.cases.active !== null ? country.cases.active : 0;
                  _this3.totalRecovered = country.cases.recovered !== null ? country.cases.recovered : 0;
                  _this3.totalDeaths = country.deaths.total !== null ? country.deaths.total : 0;
                }
              });
        ...
        value: function initChart(caseType) {
          ...
          this.globalStatsData.forEach(function (countrystats) {
            if (countrystats.country !== 'All') {
              var value;
              console.log('countrystats', countrystats);

              switch (_this5.defaultCaseType) {
                case 'confirmed':
              ...
              _this5.datatable.push([countrystats.country, value]);
            }
          });
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_input_click_24_listener($event) {
            return ctx.updateChart($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_input_click_29_listener($event) {
            return ctx.updateChart($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_input_click_34_listener($event) {
            return ctx.updateChart($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_input_click_39_listener($event) {
            return ctx.updateChart($event);
          });
      ...
      directives: [_dashboard_card_dashboard_card_component__WEBPACK_IMPORTED_MODULE_2__["DashboardCardComponent"], angular_google_charts__WEBPACK_IMPORTED_MODULE_3__["GoogleChartComponent"]],
  ...
  function srcAppServicesDataServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataServiceService = /*#__PURE__*/function () {
      function DataServiceService(http) {
        ...
        this.globalDataUrl = "".concat(this.baseUrl, '02-23-2023').concat(this.extension);
      ...
      _createClass(DataServiceService, [{
        ...
        value: function handleError(error) {
          if (error.status == 404) {
            ...
            this.year = now.getFullYear(); // this.globalDataUrl = `${this.baseUrl}${this.getDate(this.month)}-${this.getDate(this.date)}-${this.year}${this.extension}`;
        ...
        key: "getDatwWiseData",
        value: function getDatwWiseData() {
        ...
        value: function getGlobalData() {
          ...
          return this.http.get(this.baseUrl_V2 + 'countries', {
            headers: headers
          });
        }
      }, {
        key: "getGlobalStatistics",
        value: function getGlobalStatistics() {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            'X-RapidAPI-Key': '31bcaa3ac8msh6e2a7a19925c46ap1bd627jsn07bb10ca18b2',
            'X-RapidAPI-Host': 'covid-193.p.rapidapi.com'
          });
          return this.http.get(this.baseUrl_V2 + 'statistics', {
            headers: headers
          });
        }
      }]);
    ...
    DataServiceService.ɵfac = function DataServiceService_Factory(t) {
      return new (t || DataServiceService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Projects\Dev_Projects\NodeJS\Portfolio\covidTracker\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
